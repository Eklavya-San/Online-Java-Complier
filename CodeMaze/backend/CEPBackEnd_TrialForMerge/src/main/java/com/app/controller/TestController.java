...
//get by id
	...
	public ResponseEntity<?> getDetailsById(@PathVariable long testId) {
		try {
			return new ResponseEntity<>(queService.getByTestId(testId), HttpStatus.OK);
...
// get by title
	...
	public ResponseEntity<?> getDetailsByTitle(@PathVariable String testTitle) {
		try {
			return new ResponseEntity<>(queService.getByTestTitle(testTitle), HttpStatus.OK);
		} catch (RuntimeException e) {
			return new ResponseEntity<>(e.getMessage(), HttpStatus.NOT_FOUND);
		}
	}
...
// get by startDate
	...
	public ResponseEntity<?> getDetailsByStartDate(
		...
		try {
			return new ResponseEntity<>(queService.getByTestStartDate(testStartDate), HttpStatus.OK);
		} catch (RuntimeException e) {
			return new ResponseEntity<>(e.getMessage(), HttpStatus.NOT_FOUND);
		}
	}
...
// get by endDate
	...
	public ResponseEntity<?> getDetailsByEndDate(
		...
		try {
			return new ResponseEntity<>(queService.getByTestEndDate(testEndDate), HttpStatus.OK);
		} catch (RuntimeException e) {
			return new ResponseEntity<>(e.getMessage(), HttpStatus.NOT_FOUND);
		}
	}
